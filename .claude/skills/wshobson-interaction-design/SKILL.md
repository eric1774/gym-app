...
# owner: wshobson
# contentSha: 91d0a26
# installed: 2026-03-14T11:10:39.943Z
# source: https://agentskill.sh/wshobson/interaction-design
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback wshobson/interaction-design <1-5> [optional comment]
